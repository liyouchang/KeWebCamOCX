...
enum KEERRORCODE
{
	...
	KE_SUCCESS = 13,
	KE_ERROR_PARAM = 14,
	KE_SOCKET_NOTOPEN = 15,
	KE_SOCKET_ConnectionDropped = 16,
	KE_SOCKET_ConnectionError,
	KE_SOCKET_WRITEERROR = 18,
	KE_CONNECT_SERVER_ERROR = 19,
	KE_MSG_TIMEOUT = 20,
	KE_DEVOFFLINE = 21,
	KE_LOGIN_NAMEPWDERROR = 22,
	KE_LOGIN_AlreadyLogin = 23,
	KE_LOGIN_DBServerOff,
	KE_RTV_BOTHOFFLINE = 25,
	KE_RTV_DVSOFFLINE  = 26,
	KE_RTV_CHANNELDISABLE = 27,
	KE_RTV_MAXTRANSNUM = 28,
	KE_RTV_MAXVIEWNUM = 29,
	KE_RTV_MAXTCPNUM = 30,
	KE_RTV_OpenStreamFailed = 31,
	KE_RTV_OpenSoundFailed,
	KE_RTV_NOPLAY = 33,
	KE_XML_Receiving = 34,
	KE_FUNCTION_NOTSUPPORT = 35,
	KE_OTHERS
};
