...
std::string CIniFileA::GetKeyValue( const std::string& sSection, const std::string& sKey ,const std::string& sDefault ) const
{
#ifdef _CINIFILE_DEBUG
	std::cout <<  "CIniFileA::GetKeyValue()" << std::endl;
#endif
	std::string sValue = sDefault;
	CIniSectionA* pSec = GetSection( sSection );
	if( pSec )
	{
		CIniKeyA* pKey = pSec->GetKey( sKey );
...
std::wstring CIniFileW::GetKeyValue( const std::wstring& sSection, const std::wstring& sKey, const std::wstring& sDefault ) const
{
#ifdef _CINIFILE_DEBUG
	std::wcout <<  L"CIniFileW::GetKeyValue()" << std::endl;
#endif
	std::wstring sValue = sDefault;
	CIniSectionW* pSec = GetSection( sSection );
	if( pSec )
	{
		CIniKeyW* pKey = pSec->GetKey( sKey );
