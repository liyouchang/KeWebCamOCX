...
public:
	...
	//get key value with a default value
	std::string GetKeyValue( const std::string& sSection, const std::string& sKey ,const std::string& sDefault) const;
...
public:
	...
	//add by lht
	std::wstring GetKeyValue( const std::wstring& sSection, const std::wstring& sKey, const std::wstring& sDefault ) const;
    // Sets a KeyValuePair at a certain section
